            ...
            <view class="goods goods">
                ...
                <view class="meta meta">
                    <view class="price price">
                        ...
                        <text class="number sk-transparent sk-text-14-2857-757 sk-text">9.90</text>
                    </view>
                    <view class="name ellipsis sk-transparent sk-text-14-2857-443 sk-text">坚果保持干脆秘诀日本厨房密封收纳盒</view>
                    <view class="desc sk-transparent sk-text-0-0000-128 sk-text">进口优质树脂，安全无毒耐用app</view>
                </view>
                <view class="action action">
                    <view class="item arrow sk-pseudo sk-pseudo-circle">
                        <text class="label sk-transparent sk-text-14-2857-366 sk-text">选择</text>
                        <text class="text ellipsis sk-transparent sk-text-14-2857-622 sk-text"> 请选择商品规格 </text>
                    </view>
                    <view class="item arrow sk-pseudo sk-pseudo-circle">
                        <text class="label sk-transparent sk-text-14-2857-781 sk-text">送至</text>
                        <text class="text ellipsis sk-transparent sk-text-14-2857-790 sk-text"> 请选择收获地址 </text>
                    </view>
        ...
        <view class="toolbar toolbar" style="padding-bottom:0px">
            <view class="icons icons">
                <button class="icons-button sk-transparent sk-button sk-pseudo sk-pseudo-circle">
                    <text class="icon-heart sk-pseudo sk-pseudo-circle"></text>收藏</button>
                <button class="icons-button sk-transparent sk-button sk-pseudo sk-pseudo-circle" open-type="contact">
                    <text class="icon-handset sk-pseudo sk-pseudo-circle"></text>客服 </button>
            ...
            <view class="buttons buttons">
                <view class="addcart sk-transparent sk-text-31-9444-418 sk-text" style="background-position-x: 50%;"> 加入购物车
                </view>
                <view class="buynow sk-transparent sk-text-31-9444-614 sk-text" style="background-position-x: 50%;"> 立即购买
                </view>
            </view>
        </view>
    </view>
...
.sk-text-14-2857-757 {
    ...
    background-size: 100% 78.4000rpx;
